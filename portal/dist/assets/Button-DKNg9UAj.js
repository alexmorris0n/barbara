import{F as b,ba as $e,y as E,m as Z,n as p,al as ze,H as Be,r as S,an as Se,ae as Pe,v as ee,x as Te,z as y,I as Y,E as l,a8 as ke,O as Re,a9 as He,am as Ie,L as Ee,G as Oe,c as R,A as Fe,B as oe,aL as je,ab as De,ac as r,aP as H,C as Ne}from"./index-Zmiy9vUZ.js";import{i as _e,r as U,m as Ge,u as Ke,n as J,c as Me,l as Ve}from"./browser-BZH80bmF.js";const{cubicBezierEaseInOut:C}=$e;function We({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
...
`),Qe=Z({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){ze("-base-wave",qe,Be(e,"clsPrefix"));const f=S(null),h=S(!1);let u=null;return Se(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}});function z(e){return ee(e,[255,255,255,.16])}function I(e){return ee(e,[0,0,0,.12])}const Le=Te("n-button-group"),Ae=b([E("button",`
 ...
 `,[y("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),_e&&"MozBoxSizing"in document.createElement("div").style?b("&::moz-focus-inner",{border:0}):null,l("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
 ...
 align-items: center;
 justify-content: center;
 `,[ke({top:"50%",originalTransform:"translateY(-50%)"})]),We()]),l("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
