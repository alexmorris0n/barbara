...
`,[P("scrollbar",`
 ...
 `)]),V("render-label",`
 color: var(--n-text-color);
 `)]),ot("disabled",[se("&:hover",[V("state-border",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>oe(`${e}-status`,[V("state-border",`border: var(--n-border-${e});`),ot("disabled",[se("&:hover",[V("state-border",`
